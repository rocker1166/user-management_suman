...
export const metadata: Metadata = {
  ...
  description: "Create an account for the user management dashboard",
}
  ...
  return (
    <div className="container relative flex-col items-center justify-center min-h-screen grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        {/* Light aura effect for large screens only */}
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;Join our user management platform and get access to all the tools you need to manage your user accounts effectively.&rdquo;
            </p>
